...
$homepage->content = '<section id="content">
                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <a href="support-vehicles/"><button type="button" class="btn btn-danger btn-block fillArea">Support Vehicles</button></a>
                                </div>
                            </div><!--/.row-->
                        </div><!--/.container-->
                        </section><!--/#content-->
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-sm-6">
                                    <a href="divisions/"><button type="button" class="btn btn-danger btn-block fillArea">Divisional Histories</button></a>
                                </div>
                                <div class="col-sm-6">
...
$homepage->title = $homepage->title . ' - America';
