...
$(document).ready(function(){
    ...
    function showAFVs(obj) {
        $("table#tblNewItem > tbody:last").append('<tr><th>ID</th><th>Name</th><th>Title</th><th>Friendly Url</th><th>Image</th><th>Image Source</th><th>Short Text</th><th>Year</th><th>Vehicle Type</th><th>Origin & Designer</th><th>Numbers Produced</th><th>Crew</th><th>Main Armament</th><th>Sponson Traverse</th><th>Elevation</th>\n\
                                                  ...
                                                  <tr><td></td><td><input type="text" /></td><td><input type="text" /></td><td><input type="text" /></td><td><input type="text" /></td><td><input type="text" /></td><td><input type="text" /></td><td><input type="text" /></td><td><input type="text" /></td><td><input type="text" /></td><td><input type="text" /></td><td><input type="text" /></td><td><input type="text" /></td>\n\
    ...
    function showArtillery(obj) {
        $("table#tblNewItem > tbody:last").append('<tr><th>ID</th><th>Name</th><th>Title</th><th>Friendly Url</th><th>Image</th><th>Image Source</th><th>Short Text</th><th>Year</th><th>Weapon Type</th><th>Origin & Designer</th><th>Numbers Produced</th><th>Calibre</th><th>Barrel Length</th><th>Carriage</th><th>Gun Shield</th><th>Height</th>\n\
                                                  ...
                                                  <tr><td></td><td><input type="text" /></td><td><input type="text" /></td><td><input type="text" /></td><td><input type="text" /></td><td><input type="text" /></td><td><input type="text" /></td><td><input type="text" /></td><td><input type="text" /></td>\n\
	...
	var operation = row.find("td").eq(22).find("input").val();
        ...
        $.ajax({
            ...
            data: {action: 'updateInfantryWeapon', item_id: item_id, name: name, title: title, friendly_url: friendly_url, image: image, image_source: image_source, short_text: short_text, 
                ...
                blank_cartridge: blank_cartridge, muzzle_velocity: muzzle_velocity, fuel_capacity: fuel_capacity, minimum_range: minimum_range, effective_range: effective_range, maximum_range: maximum_range, armour_penetration: armour_penetration, bayonet: bayonet, traction: traction, variants: variants, notes: notes},
            cache: false,
            beforeSend: function () {
                myApp.showPleaseWait();
            },
    ...
    function showDivisions(obj) {
        $("table#tblNewItem > tbody:last").append('<tr><th>ID</th><th>Name</th><th>Title</th><th>Friendly Url</th><th>Image</th><th>Image Source</th><th>Short Text</th><th>Content</th><th></th></tr>\n\
